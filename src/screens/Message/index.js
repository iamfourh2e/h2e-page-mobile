...
export default class Message extends Component {
  ...
  showLocalNotification() {
    FCM.presentLocalNotification({
      ...
      click_action: "com.h2e.page", // as FCM payload - this is used as category identifier on iOS.
  ...
  showLocalNotificationWithAction() {
    FCM.presentLocalNotification({
      ...
      priority: "high",
      show_in_foreground: true,
      click_action: "com.h2e.page.fcm.text", // for ios
    ...
    return (
      <View style={styles.container}>
        <ScrollView style={{paddingHorizontal: 20}}>
          ...
          <Text style={styles.feedback}>{tokenCopyFeedback}</Text>
