...
const cinemaItems = [
    ...
    {
        logo: 'https://panpages.blob.core.windows.net/pp-kh/kh/logo_images/original/1378713441/1369284?1378713441',
        companyName: "LEGEND CINEMA",
        description: 'រោងភាពយន្ត',
        rateValue: 3.3
    },
    {
        logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTAQQir0M4zdZjc5O5GUUb0yfhHXSU2_Ro0Mu6MUSbngMajx817',
        companyName: "Major Cineplex",
        description: 'រោងភាពយន្ត',
        rateValue: 3.5
    }
];
const restaurantItems = [
    ...
    {
        logo: 'https://www.koulenrestaurant.com/images/koulenlogo.png',
        companyName: "koulenlogo Restaurant",
        description: 'Restaurant',
        rateValue: 3.6
    },
    {
        logo: 'https://panpages.blob.core.windows.net/pp-kh/kh/logo_images/original/1423543702/1981328?1423543702',
        companyName: "Phanha Khmer Restaurant ",
        description: 'Restaurant',
        rateValue: 3.5
    },
    {
        logo: 'https://www.malis-restaurant.com/phnompenh/wp-content/uploads/2015/12/malis-logo-square.png',
        companyName: "Malis Restaurant ",
        description: 'Restaurant',
        rateValue: 3.9
    },
];
