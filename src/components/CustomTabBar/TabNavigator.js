/*
*
* Source from react-navigation
* adding padding 35 for bottomTabIcons (fix khmer fonts issue)
*
* */
...
import {
  createNavigator, createNavigationContainer, TabRouter, TabView, TabBarTop,
  // TabBarBottom
