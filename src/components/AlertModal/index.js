...
class AlertModal extends React.PureComponent {
        ...
        <Animated.View style={[styles.mainContainer, animatedStyle.scrollY]}>
          ...
          <View style={styles.modalContainer}>
            ...
            <View style={[styles.messageContainer, {
              paddingBottom: this.state.msgPaddingBottom,
              paddingTop: this.state.msgPaddingTop
            }]}>
  ...
  alert = ({headerColor = "#000", headerBackgroundColor = "transparent", title, message, buttons, msgPaddingTop, msgPaddingBottom}) => {
    this.setState({
      headerColor: headerColor,
